...
class Scientific extends m.Element(`calc3-scientific`) {
  ...
  updateLayout(info) {
    ...
    dom.setAttribute($(this, `diagram-labels`), `data-state`, rect.height > threshold ? `visible` : `hidden`);
  }
}

m.register(Scientific);
